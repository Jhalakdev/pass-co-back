...
router.put("/update-coupen/:id",userAuth,isAdmin,coupenController.updateCoupen);
router.delete("/delete-coupen/:id",userAuth,isAdmin,coupenController.deleteCoupen);
